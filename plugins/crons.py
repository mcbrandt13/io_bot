...
class crons(WillPlugin):
  ...
  def aperta_triage(self):
    ...
    with codecs.open('/home/kbrandt/iobot/io_bot/plugins/yesterday.txt', 'r') as f:
      yesterday = f.readlines()
      yesterday = yesterday[0].strip()
      today = people[yesterday]
    with codecs.open('/home/kbrandt/iobot/io_bot/plugins/yesterday.txt', 'w') as f:
      f.write(today)

    self.say("@{0}, today is your turn to triage support tickets!".format(today), room=self.available_rooms['Editorial Manager Support'])
  ...
  def assess_triage(self):
    ...
    with codecs.open('/home/kbrandt/iobot/io_bot/plugins/assess.txt', 'r') as f:
    ...
    with codecs.open('/home/kbrandt/iobot/io_bot/plugins/assess.txt', 'w') as f:
